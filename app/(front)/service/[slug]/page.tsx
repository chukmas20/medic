...
const page =async ({
 ...
 searchParams:{[key:string]:string | string[] | undefined}
    ...
    const doctors = await getDoctorsBySlug(slug) || []
    console.log(doctors);
  return (
    <div className='container p-8'>
        ...
        <div className='max-w-6xl mx-auto grid grid-cols-12 gap-6 lg:gap-10'>
            <div className='col-span-4 shadow border border-gray-200/50 rounded p-6'>
              <h2 className='capitalize font-semibold'>Other Services</h2>
                 <div className='py-3 flex  flex-col text-sm space-y-2'>
                   <Link href="#" className='hover:text-yellow-600'>Link One</Link>
                   <Link href="#" className='hover:text-yellow-600'>Link One</Link>
                   <Link href="#" className='hover:text-yellow-600'>Link One</Link>
                   <Link href="#" className='hover:text-yellow-600'>Link One</Link>
                   <Link href="#" className='hover:text-yellow-600'>Link One</Link>
